...
/**
 * Provides a TaskTypeBase for plugins to extends.
 */
abstract class TaskTypeBase extends PluginBase implements BundlePluginInterface, ContainerFactoryPluginInterface {
