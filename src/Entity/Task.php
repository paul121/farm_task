 ...
 *      "form" = {
 *        "add" = "Drupal\farm_task\Form\TaskForm",
 *        "edit" = "Drupal\farm_task\Form\TaskForm",
...
class Task extends RevisionableContentEntityBase implements TaskInterface {
  ...
  public function buildTaskForm(array &$form, FormStateInterface $form_state) {
    $value_field = "{$this->bundle()}_value";
    if (isset($form[$value_field]['widget'][5])) {
//      $form[$value_field]['widget'][0]['#title'] = $this->label();
//      $form[$value_field]['widget'][0]['#description'] = $this->get('description')->value;
    }
    else {
//      $form[$value_field]['widget']['value']['#title'] = $this->label();
//      $form[$value_field]['widget']['value']['#description'] = $this->get('description')->value;
    }
